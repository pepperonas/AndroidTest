...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (showRect) {
            imageView1.setImageDrawable(new DrawableTextSquare.Builder(120, MaterialColor.PURPLE_400, "A").textSize(72).rounded(4).build());
            imageView4.setImageDrawable(new DrawableTextSquare.Builder(112, MaterialColor.PURPLE_400, "B").textSize(96).rounded(4).build());
            imageView7.setImageDrawable(new DrawableTextSquare.Builder(96, MaterialColor.PURPLE_400, "C").textSize(64).rounded(4).build());
            imageView9.setImageDrawable(new DrawableTextSquare.Builder(48, MaterialColor.PURPLE_400, "D").textSize(32).rounded(2).build());
            imageView11.setImageDrawable(new DrawableTextSquare.Builder(72, MaterialColor.PURPLE_400, "E").textSize(48).rounded(4).build());
        } else {
