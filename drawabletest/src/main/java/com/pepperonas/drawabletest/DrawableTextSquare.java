...
import com.pepperonas.andcommon.system.DeviceUtils;
import com.pepperonas.javabase.div.MaterialColor;

/**
 * @author Martin Pfeffer (pepperonas)
 */
public class DrawableTextSquare extends Drawable {
    ...
    public DrawableTextSquare(Builder builder) {
    ...
    public static class Builder {
        ...
        public DrawableTextSquare build() {
            return new DrawableTextSquare(this);
        }
